 ...
 * 广告页相关
 */
public class Home_Banner_LoopViewPager extends ViewPager {
    private static final boolean DEFAULT_BOUNDARY_CASHING = false;
    private static final boolean DEFAULT_BOUNDARY_LOOPING = true;

    private Home_Banner_LoopPagerAdapterWrapper mAdapter;
    ...
    public void setAdapter(PagerAdapter adapter) {
        mAdapter = new Home_Banner_LoopPagerAdapterWrapper(adapter);
    ...
    public Home_Banner_LoopViewPager(Context context) {
        super(context);
        init(context);
    }

    public Home_Banner_LoopViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageScrollStateChanged(int state) {
            if (mAdapter != null) {
                int position = Home_Banner_LoopViewPager.super.getCurrentItem();
                int realPosition = mAdapter.toRealPosition(position);
