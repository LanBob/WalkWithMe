...
public class SharedPreferencesHelper {
    ...
    /**
     * 使用：context是上下文，filename是一个文件袋额名称，token
     * @param context
     * @return
     */
    public static String getToken(Context context){
        SharedPreferencesHelper helper = new SharedPreferencesHelper(context, "token");
    ...
    public static void setToken(Context context,String token){
        SharedPreferencesHelper helper = new SharedPreferencesHelper(context, "token");
        helper.putValues(new SharedPreferencesHelper.ContentValue("token", token));
        return;
    }
}
